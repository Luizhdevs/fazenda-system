...
export default function Layout() {
  ...
  return (
    <div style={{ maxWidth: '480px', margin: '0 auto', height: 'calc(var(--vh, 1vh) * 100)', display: 'flex', flexDirection: 'column', background: '#F4F6F4', position: 'relative', overflow: 'hidden' }}>
